...
-   эффект "Радуга диагональная" и "Звездопад" (версия 1.1), Метель и Горящий Шум (1.31)
...
-	для 1.3 версии нужно брать оригинал gyverbutton от https://github.com/AlexGyver/GyverLibs;
