    ...
    if (ONflag && millis() - effTimer >= ((currentMode < 5 || currentMode > 13) ? modes[currentMode].Speed : 50) ) {
      ...
      switch (currentMode) {
        case 0: sparklesRoutine();
          break;
        case 1: fireRoutine(true);
          break;
        case 2: fireRoutine(false);
          break;
        case 3: rainbowVertical();
          break;
        case 4: rainbowHorizontal();
          break;
        case 5: rainbowDiagonalRoutine();
          break;
        case 6: madnessNoise();
          break;
        case 7: cloudNoise();
        ...
        case 16: smokeNoise();
         break; 
        case 17: colorRoutine();
          break;
        case 18: colorsRoutine();
          break;
        case 19: whiteLamp();
          break;
        case 20: matrixRoutine();
         break;
        case 21: snowRoutine();
         break;
        case 22: stormRoutine2(true);
         break;
        case 23: stormRoutine2(false);
         break;
        case 24: SinusoidRoutine();
         break;
        case 25: MetaBallsRoutine();
         break;
        case 26: ballRoutine();
         break;
        case 27: ballsRoutine();
         break;
        case 28: fire2012WithPalette4in1();
         break; 
        case 29: fire2012WithPalette();
         break;
        case 30: noiseWave(false);
         break;
        case 31: noiseWave(true);
         break;
        case 32: coloredRain();
         break;
      }
